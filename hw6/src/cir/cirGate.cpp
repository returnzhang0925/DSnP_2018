...
// 		}
// 		if(!dofingate->get_fin().empty())
// 		{
// 			bool mark_3 = false;
// 			for(unsigned j = 0; j < dofingate->get_fin().size(); j++)
// 			{
// 				if(dofingate->get_fin()[j]->get_fin().empty())
// 					mark_3 = true;
// 			}
// 			if(mark_3 == true) {dofingate->setToGlobalRef();}
// 		}
...
// 		}
// 		if(!dofougate->get_fout().empty())
// 		{
// 			bool mark_3 = false;
// 			for(unsigned j = 0; j < dofougate->get_fout().size(); j++)
// 			{
// 				if(dofougate->get_fout()[j]->get_fout().empty())
// 					mark_3 = true;
// 			}
// 			if(mark_3 == true) {dofougate->setToGlobalRef();}
// 		}
// 	}
// }
// void
...
// 			{
// 				if(this->fanin[i]->fou_invert.size() && this->fin_invert.size())
// 					{cout << "!"; break;}
// 			}
// 		}
